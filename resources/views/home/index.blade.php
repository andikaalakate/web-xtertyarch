...
<head>
    ...
    <style>
        ...
        #logo img {
        transition: filter 0.5s ease; /* Efek transisi saat perubahan filter */
        }
        #logo.scrolled img {
            filter: invert(100%); /* Mengubah warna menjadi negatif saat di-scroll */
        }
    </style>
</head>
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            <div class="pl-4 flex items-center">
                <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
                    ...
                    <img src="{{ asset('xtaa.png') }}" alt="" class="h-20 fill-current inline">
                </a>
            </div>
            ...
            <div class="w-full flex flex-col md:flex-row py-6">
                <div class="flex-1 mb-6 text-black">
                    <a class="text-pink-600 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
                        href="#">
                        <img src="{{ asset('xtaa.png') }}" alt="" class="h-20 fill-current inline invert">
                    </a>
                </div>
                <div class="flex-1">
